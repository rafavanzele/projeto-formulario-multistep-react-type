...
const Thanks = ({data}: ThanksProps) => {
  return (
    <div className="thanks-container">
      ...
      <p>A sua opinião é muito importante para nós. Em breve você receberá um cupom de 10% de desconto na sua próxima compra.</p>

      <p>Para concluir sua avaliação, clique no botão abaixo de enviar.</p>
