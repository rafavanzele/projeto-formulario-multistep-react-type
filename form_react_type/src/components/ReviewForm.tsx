  ...
  return (
    <div className="review-form">
      <div className="form-control score-container">
        ...
        <label className="radio-container">
          <input type="radio" value={'very-satisfied'} name="review" required checked={data.review === 'very-satisfied'} onChange={(e) => updateFieldHandler('review', e.target.value)}/>
          <BsFillEmojiHeartEyesFill/>
      ...
      <div className="form-control">
        ...
        <textarea name="comment" id="comment" placeholder="Conte como foi sua experiência com nosso produto..." required value={data.comment || ''} onChange={(e) => updateFieldHandler('comment', e.target.value)}></textarea>
      </div>
    </div>
  )
}
